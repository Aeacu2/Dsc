...
structure Bench_Gen : sig
  ...
  type root_info
  val dsc_int : rat -> rat -> int poly -> (rat * rat) list
  val dsc_exec : real -> real -> real poly -> (real * real) list
  val newdsc_int : rat -> rat -> nat -> int poly -> (rat * rat) list
...
type 'a ordered_semiring_strict =
  {ordered_cancel_ab_semigroup_add_ordered_semiring_strict :
     'a ordered_cancel_ab_semigroup_add,
    ordered_semiring_ordered_semiring_strict : 'a ordered_semiring,
    semiring_0_cancel_ordered_semiring_strict : 'a semiring_0_cancel};
val ordered_cancel_ab_semigroup_add_ordered_semiring_strict =
  #ordered_cancel_ab_semigroup_add_ordered_semiring_strict :
  'a ordered_semiring_strict -> 'a ordered_cancel_ab_semigroup_add;
val ordered_semiring_ordered_semiring_strict =
  #ordered_semiring_ordered_semiring_strict :
  'a ordered_semiring_strict -> 'a ordered_semiring;
val semiring_0_cancel_ordered_semiring_strict =
  #semiring_0_cancel_ordered_semiring_strict :
  'a ordered_semiring_strict -> 'a semiring_0_cancel;
...
type 'a linordered_semiring_strict =
  {linordered_semiring_linordered_semiring_strict : 'a linordered_semiring,
    ordered_semiring_strict_linordered_semiring_strict :
      'a ordered_semiring_strict};
...
val ordered_semiring_strict_linordered_semiring_strict =
  #ordered_semiring_strict_linordered_semiring_strict :
  'a linordered_semiring_strict -> 'a ordered_semiring_strict;

type 'a ordered_semiring_1 =
  {ordered_semiring_0_ordered_semiring_1 : 'a ordered_semiring_0,
    semiring_1_ordered_semiring_1 : 'a semiring_1,
    zero_less_one_ordered_semiring_1 : 'a zero_less_one};
val ordered_semiring_0_ordered_semiring_1 =
  #ordered_semiring_0_ordered_semiring_1 :
  'a ordered_semiring_1 -> 'a ordered_semiring_0;
val semiring_1_ordered_semiring_1 = #semiring_1_ordered_semiring_1 :
  'a ordered_semiring_1 -> 'a semiring_1;
val zero_less_one_ordered_semiring_1 = #zero_less_one_ordered_semiring_1 :
  'a ordered_semiring_1 -> 'a zero_less_one;

type 'a ordered_semiring_1_strict =
  {ordered_semiring_1_ordered_semiring_1_strict : 'a ordered_semiring_1,
    ordered_semiring_strict_ordered_semiring_1_strict :
      'a ordered_semiring_strict};
val ordered_semiring_1_ordered_semiring_1_strict =
  #ordered_semiring_1_ordered_semiring_1_strict :
  'a ordered_semiring_1_strict -> 'a ordered_semiring_1;
val ordered_semiring_strict_ordered_semiring_1_strict =
  #ordered_semiring_strict_ordered_semiring_1_strict :
  'a ordered_semiring_1_strict -> 'a ordered_semiring_strict;

type 'a linordered_semiring_1 =
  {linordered_semiring_linordered_semiring_1 : 'a linordered_semiring,
    ordered_semiring_1_linordered_semiring_1 : 'a ordered_semiring_1};
...
val ordered_semiring_1_linordered_semiring_1 =
  #ordered_semiring_1_linordered_semiring_1 :
  'a linordered_semiring_1 -> 'a ordered_semiring_1;
...
type 'a linordered_semiring_1_strict =
  {linordered_semiring_1_linordered_semiring_1_strict :
    ...
    ordered_semiring_1_strict_linordered_semiring_1_strict :
      'a ordered_semiring_1_strict};
...
val ordered_semiring_1_strict_linordered_semiring_1_strict =
  #ordered_semiring_1_strict_linordered_semiring_1_strict :
  'a linordered_semiring_1_strict -> 'a ordered_semiring_1_strict;
...
type 'a ordered_comm_semiring_strict =
  {ordered_cancel_comm_semiring_ordered_comm_semiring_strict :
     'a ordered_cancel_comm_semiring,
    ordered_semiring_strict_ordered_comm_semiring_strict :
      'a ordered_semiring_strict};
val ordered_cancel_comm_semiring_ordered_comm_semiring_strict =
  #ordered_cancel_comm_semiring_ordered_comm_semiring_strict :
  'a ordered_comm_semiring_strict -> 'a ordered_cancel_comm_semiring;
val ordered_semiring_strict_ordered_comm_semiring_strict =
  #ordered_semiring_strict_ordered_comm_semiring_strict :
  'a ordered_comm_semiring_strict -> 'a ordered_semiring_strict;

type 'a linordered_comm_semiring_strict =
  {linordered_semiring_strict_linordered_comm_semiring_strict :
     'a linordered_semiring_strict,
    ordered_comm_semiring_strict_linordered_comm_semiring_strict :
      'a ordered_comm_semiring_strict};
...
val ordered_comm_semiring_strict_linordered_comm_semiring_strict =
  #ordered_comm_semiring_strict_linordered_comm_semiring_strict :
  'a linordered_comm_semiring_strict -> 'a ordered_comm_semiring_strict;
...
type 'a linordered_nonzero_semiring =
  {semiring_char_0_linordered_nonzero_semiring : 'a semiring_char_0,
    ...
    ordered_comm_semiring_linordered_nonzero_semiring :
      'a ordered_comm_semiring,
    ordered_semiring_1_linordered_nonzero_semiring : 'a ordered_semiring_1};
...
val ordered_semiring_1_linordered_nonzero_semiring =
  #ordered_semiring_1_linordered_nonzero_semiring :
  'a linordered_nonzero_semiring -> 'a ordered_semiring_1;
...
val ordered_semiring_strict_int =
  {ordered_cancel_ab_semigroup_add_ordered_semiring_strict =
     ordered_cancel_ab_semigroup_add_int,
    ordered_semiring_ordered_semiring_strict = ordered_semiring_int,
    semiring_0_cancel_ordered_semiring_strict = semiring_0_cancel_int}
  : int ordered_semiring_strict;
...
val linordered_semiring_strict_int =
  {linordered_semiring_linordered_semiring_strict = linordered_semiring_int,
    ordered_semiring_strict_linordered_semiring_strict =
      ordered_semiring_strict_int}
  : int linordered_semiring_strict;

val ordered_semiring_1_int =
  {ordered_semiring_0_ordered_semiring_1 = ordered_semiring_0_int,
    semiring_1_ordered_semiring_1 = semiring_1_int,
    zero_less_one_ordered_semiring_1 = zero_less_one_int}
  : int ordered_semiring_1;

val ordered_semiring_1_strict_int =
  {ordered_semiring_1_ordered_semiring_1_strict = ordered_semiring_1_int,
    ordered_semiring_strict_ordered_semiring_1_strict =
      ordered_semiring_strict_int}
  : int ordered_semiring_1_strict;

val linordered_semiring_1_int =
  {linordered_semiring_linordered_semiring_1 = linordered_semiring_int,
    ordered_semiring_1_linordered_semiring_1 = ordered_semiring_1_int}
...
fun unit_factor_nata n = of_bool zero_neq_one_nat (less_nat zero_nata n);

val unit_factor_nat = {unit_factor = unit_factor_nata} : nat unit_factor;
...
val zero_less_one_nat =
  {order_zero_less_one = order_nat,
    zero_neq_one_zero_less_one = zero_neq_one_nat}
  : nat zero_less_one;
...
val ordered_semiring_nat =
  {ordered_comm_monoid_add_ordered_semiring = ordered_comm_monoid_add_nat,
    semiring_ordered_semiring = semiring_nat}
  : nat ordered_semiring;

val strict_ordered_ab_semigroup_add_nat =
  {ordered_ab_semigroup_add_strict_ordered_ab_semigroup_add =
     ordered_ab_semigroup_add_nat}
  : nat strict_ordered_ab_semigroup_add;

val ordered_cancel_ab_semigroup_add_nat =
  {cancel_ab_semigroup_add_ordered_cancel_ab_semigroup_add =
     cancel_ab_semigroup_add_nat,
    strict_ordered_ab_semigroup_add_ordered_cancel_ab_semigroup_add =
      strict_ordered_ab_semigroup_add_nat}
  : nat ordered_cancel_ab_semigroup_add;

val ordered_semiring_0_nat =
  {ordered_semiring_ordered_semiring_0 = ordered_semiring_nat,
    semiring_0_ordered_semiring_0 = semiring_0_nat}
  : nat ordered_semiring_0;

val ordered_cancel_semiring_nat =
  {ordered_cancel_ab_semigroup_add_ordered_cancel_semiring =
     ordered_cancel_ab_semigroup_add_nat,
    ordered_semiring_0_ordered_cancel_semiring = ordered_semiring_0_nat,
    semiring_0_cancel_ordered_cancel_semiring = semiring_0_cancel_nat}
  : nat ordered_cancel_semiring;

val ordered_comm_semiring_nat =
  {comm_semiring_0_ordered_comm_semiring = comm_semiring_0_nat,
    ordered_semiring_ordered_comm_semiring = ordered_semiring_nat}
  : nat ordered_comm_semiring;

val ordered_cancel_comm_semiring_nat =
  {comm_semiring_0_cancel_ordered_cancel_comm_semiring =
     comm_semiring_0_cancel_nat,
    ordered_cancel_semiring_ordered_cancel_comm_semiring =
      ordered_cancel_semiring_nat,
    ordered_comm_semiring_ordered_cancel_comm_semiring =
      ordered_comm_semiring_nat}
  : nat ordered_cancel_comm_semiring;

val ordered_semiring_strict_nat =
  {ordered_cancel_ab_semigroup_add_ordered_semiring_strict =
     ordered_cancel_ab_semigroup_add_nat,
    ordered_semiring_ordered_semiring_strict = ordered_semiring_nat,
    semiring_0_cancel_ordered_semiring_strict = semiring_0_cancel_nat}
  : nat ordered_semiring_strict;

val ordered_comm_semiring_strict_nat =
  {ordered_cancel_comm_semiring_ordered_comm_semiring_strict =
     ordered_cancel_comm_semiring_nat,
    ordered_semiring_strict_ordered_comm_semiring_strict =
      ordered_semiring_strict_nat}
  : nat ordered_comm_semiring_strict;

val ordered_ab_semigroup_add_imp_le_nat =
  {ordered_cancel_ab_semigroup_add_ordered_ab_semigroup_add_imp_le =
     ordered_cancel_ab_semigroup_add_nat}
  : nat ordered_ab_semigroup_add_imp_le;

val strict_ordered_comm_monoid_add_nat =
  {comm_monoid_add_strict_ordered_comm_monoid_add = comm_monoid_add_nat,
    strict_ordered_ab_semigroup_add_strict_ordered_comm_monoid_add =
      strict_ordered_ab_semigroup_add_nat}
  : nat strict_ordered_comm_monoid_add;

val ordered_cancel_comm_monoid_add_nat =
  {ordered_cancel_ab_semigroup_add_ordered_cancel_comm_monoid_add =
     ordered_cancel_ab_semigroup_add_nat,
    ordered_comm_monoid_add_ordered_cancel_comm_monoid_add =
      ordered_comm_monoid_add_nat,
    strict_ordered_comm_monoid_add_ordered_cancel_comm_monoid_add =
      strict_ordered_comm_monoid_add_nat}
  : nat ordered_cancel_comm_monoid_add;

val ordered_ab_semigroup_monoid_add_imp_le_nat =
  {cancel_comm_monoid_add_ordered_ab_semigroup_monoid_add_imp_le =
     cancel_comm_monoid_add_nat,
    ordered_ab_semigroup_add_imp_le_ordered_ab_semigroup_monoid_add_imp_le =
      ordered_ab_semigroup_add_imp_le_nat,
    ordered_cancel_comm_monoid_add_ordered_ab_semigroup_monoid_add_imp_le =
      ordered_cancel_comm_monoid_add_nat}
  : nat ordered_ab_semigroup_monoid_add_imp_le;

val linordered_ab_semigroup_add_nat =
  {ordered_ab_semigroup_add_linordered_ab_semigroup_add =
     ordered_ab_semigroup_add_nat,
    linorder_linordered_ab_semigroup_add = linorder_nat}
  : nat linordered_ab_semigroup_add;

val linordered_cancel_ab_semigroup_add_nat =
  {linordered_ab_semigroup_add_linordered_cancel_ab_semigroup_add =
     linordered_ab_semigroup_add_nat,
    ordered_ab_semigroup_add_imp_le_linordered_cancel_ab_semigroup_add =
      ordered_ab_semigroup_add_imp_le_nat}
  : nat linordered_cancel_ab_semigroup_add;

val linordered_semiring_nat =
  {linordered_cancel_ab_semigroup_add_linordered_semiring =
     linordered_cancel_ab_semigroup_add_nat,
    ordered_ab_semigroup_monoid_add_imp_le_linordered_semiring =
      ordered_ab_semigroup_monoid_add_imp_le_nat,
    ordered_cancel_semiring_linordered_semiring = ordered_cancel_semiring_nat}
  : nat linordered_semiring;

val linordered_semiring_strict_nat =
  {linordered_semiring_linordered_semiring_strict = linordered_semiring_nat,
    ordered_semiring_strict_linordered_semiring_strict =
      ordered_semiring_strict_nat}
  : nat linordered_semiring_strict;

val linordered_comm_semiring_strict_nat =
  {linordered_semiring_strict_linordered_comm_semiring_strict =
     linordered_semiring_strict_nat,
    ordered_comm_semiring_strict_linordered_comm_semiring_strict =
      ordered_comm_semiring_strict_nat}
  : nat linordered_comm_semiring_strict;

val ordered_semiring_1_nat =
  {ordered_semiring_0_ordered_semiring_1 = ordered_semiring_0_nat,
    semiring_1_ordered_semiring_1 = semiring_1_nat,
    zero_less_one_ordered_semiring_1 = zero_less_one_nat}
  : nat ordered_semiring_1;

val linordered_nonzero_semiring_nat =
  {semiring_char_0_linordered_nonzero_semiring = semiring_char_0_nat,
    linorder_linordered_nonzero_semiring = linorder_nat,
    comm_semiring_1_linordered_nonzero_semiring = comm_semiring_1_nat,
    ordered_comm_semiring_linordered_nonzero_semiring =
      ordered_comm_semiring_nat,
    ordered_semiring_1_linordered_nonzero_semiring = ordered_semiring_1_nat}
  : nat linordered_nonzero_semiring;

val linordered_semidom_nat =
  {linordered_comm_semiring_strict_linordered_semidom =
     linordered_comm_semiring_strict_nat,
    linordered_nonzero_semiring_linordered_semidom =
      linordered_nonzero_semiring_nat,
    semidom_linordered_semidom = semidom_nat}
  : nat linordered_semidom;

fun id x = (fn xa => xa) x;

fun normalize_nat x = id x;

type 'a discrete_linordered_semidom =
  {linordered_semidom_discrete_linordered_semidom : 'a linordered_semidom};
val linordered_semidom_discrete_linordered_semidom =
  #linordered_semidom_discrete_linordered_semidom :
  'a discrete_linordered_semidom -> 'a linordered_semidom;

type 'a check_prime_by_range =
  {discrete_linordered_semidom_check_prime_by_range :
     'a discrete_linordered_semidom,
    normalization_semidom_check_prime_by_range : 'a normalization_semidom};
val discrete_linordered_semidom_check_prime_by_range =
  #discrete_linordered_semidom_check_prime_by_range :
  'a check_prime_by_range -> 'a discrete_linordered_semidom;
val normalization_semidom_check_prime_by_range =
  #normalization_semidom_check_prime_by_range :
  'a check_prime_by_range -> 'a normalization_semidom;

val discrete_linordered_semidom_nat =
  {linordered_semidom_discrete_linordered_semidom = linordered_semidom_nat} :
  nat discrete_linordered_semidom;

val semidom_divide_unit_factor_nat =
  {semidom_divide_semidom_divide_unit_factor = semidom_divide_nat,
    unit_factor_semidom_divide_unit_factor = unit_factor_nat}
  : nat semidom_divide_unit_factor;

val normalization_semidom_nat =
  {algebraic_semidom_normalization_semidom = algebraic_semidom_nat,
    semidom_divide_unit_factor_normalization_semidom =
      semidom_divide_unit_factor_nat,
    normalizea = normalize_nat}
  : nat normalization_semidom;

val check_prime_by_range_nat =
  {discrete_linordered_semidom_check_prime_by_range =
     discrete_linordered_semidom_nat,
    normalization_semidom_check_prime_by_range = normalization_semidom_nat}
  : nat check_prime_by_range;
  ...
  Frct let
       ...
       in
         (if equal_inta a zero_inta then (zero_inta, one_inta)
           else (times_inta (sgn_inta a) b, abs_inta a))
       end;
...
val ordered_semiring_strict_rat =
  {ordered_cancel_ab_semigroup_add_ordered_semiring_strict =
     ordered_cancel_ab_semigroup_add_rat,
    ordered_semiring_ordered_semiring_strict = ordered_semiring_rat,
    semiring_0_cancel_ordered_semiring_strict = semiring_0_cancel_rat}
  : rat ordered_semiring_strict;
...
val linordered_semiring_strict_rat =
  {linordered_semiring_linordered_semiring_strict = linordered_semiring_rat,
    ordered_semiring_strict_linordered_semiring_strict =
      ordered_semiring_strict_rat}
  : rat linordered_semiring_strict;

val ordered_semiring_1_rat =
  {ordered_semiring_0_ordered_semiring_1 = ordered_semiring_0_rat,
    semiring_1_ordered_semiring_1 = semiring_1_rat,
    zero_less_one_ordered_semiring_1 = zero_less_one_rat}
  : rat ordered_semiring_1;

val ordered_semiring_1_strict_rat =
  {ordered_semiring_1_ordered_semiring_1_strict = ordered_semiring_1_rat,
    ordered_semiring_strict_ordered_semiring_1_strict =
      ordered_semiring_strict_rat}
  : rat ordered_semiring_1_strict;

val linordered_semiring_1_rat =
  {linordered_semiring_linordered_semiring_1 = linordered_semiring_rat,
    ordered_semiring_1_linordered_semiring_1 = ordered_semiring_1_rat}
...
val ordered_comm_semiring_strict_rat =
  {ordered_cancel_comm_semiring_ordered_comm_semiring_strict =
     ordered_cancel_comm_semiring_rat,
    ordered_semiring_strict_ordered_comm_semiring_strict =
      ordered_semiring_strict_rat}
  : rat ordered_comm_semiring_strict;

val linordered_comm_semiring_strict_rat =
  {linordered_semiring_strict_linordered_comm_semiring_strict =
     linordered_semiring_strict_rat,
    ordered_comm_semiring_strict_linordered_comm_semiring_strict =
      ordered_comm_semiring_strict_rat}
...
val linordered_nonzero_semiring_rat =
  {semiring_char_0_linordered_nonzero_semiring = semiring_char_0_rat,
    ...
    ordered_comm_semiring_linordered_nonzero_semiring =
      ordered_comm_semiring_rat,
    ordered_semiring_1_linordered_nonzero_semiring = ordered_semiring_1_rat}
...
type 'a ordered_semiring_1a =
  {semiring_1_ordered_semiring_1a : 'a semiring_1,
    ordered_semiring_0_ordered_semiring_1a : 'a ordered_semiring_0a};
val semiring_1_ordered_semiring_1a = #semiring_1_ordered_semiring_1a :
  'a ordered_semiring_1a -> 'a semiring_1;
val ordered_semiring_0_ordered_semiring_1a =
  #ordered_semiring_0_ordered_semiring_1a :
  'a ordered_semiring_1a -> 'a ordered_semiring_0a;

type 'a poly_carrier =
  {comm_semiring_1_poly_carrier : 'a comm_semiring_1,
    ordered_semiring_1_poly_carrier : 'a ordered_semiring_1a};
...
val ordered_semiring_1_poly_carrier = #ordered_semiring_1_poly_carrier :
  'a poly_carrier -> 'a ordered_semiring_1a;
...
val ordered_semiring_1_rata =
  {semiring_1_ordered_semiring_1a = semiring_1_rat,
    ordered_semiring_0_ordered_semiring_1a = ordered_semiring_0_rata}
  : rat ordered_semiring_1a;

val poly_carrier_rat =
  {comm_semiring_1_poly_carrier = comm_semiring_1_rat,
    ordered_semiring_1_poly_carrier = ordered_semiring_1_rata}
  : rat poly_carrier;

type 'a unbounded_dense_order =
  {dense_order_unbounded_dense_order : 'a dense_order,
    no_bot_unbounded_dense_order : 'a no_bot,
    no_top_unbounded_dense_order : 'a no_top};
val dense_order_unbounded_dense_order = #dense_order_unbounded_dense_order :
  'a unbounded_dense_order -> 'a dense_order;
val no_bot_unbounded_dense_order = #no_bot_unbounded_dense_order :
  'a unbounded_dense_order -> 'a no_bot;
val no_top_unbounded_dense_order = #no_top_unbounded_dense_order :
  'a unbounded_dense_order -> 'a no_top;
...
type 'a unbounded_dense_linorder =
  {dense_linorder_unbounded_dense_linorder : 'a dense_linorder,
    unbounded_dense_order_unbounded_dense_linorder : 'a unbounded_dense_order};
...
val unbounded_dense_order_unbounded_dense_linorder =
  #unbounded_dense_order_unbounded_dense_linorder :
  'a unbounded_dense_linorder -> 'a unbounded_dense_order;
...
val unbounded_dense_order_rat =
  {dense_order_unbounded_dense_order = dense_order_rat,
    no_bot_unbounded_dense_order = no_bot_rat,
    no_top_unbounded_dense_order = no_top_rat}
  : rat unbounded_dense_order;
...
val unbounded_dense_linorder_rat =
  {dense_linorder_unbounded_dense_linorder = dense_linorder_rat,
    unbounded_dense_order_unbounded_dense_linorder = unbounded_dense_order_rat}
...
fun cf_pos_poly f =
  let
    ...
    val a = times_inta (sgn_inta (coeff zero_int f (degree zero_int f))) c;
  in
...
fun next_subseqs1 f head tail ret0 ret1 [] = (ret0, (head, (tail, ret1)))
  | next_subseqs1 f head tail ret0 ret1 ((i, v) :: prevs) =
    next_subseqs2 f head tail (f head v :: ret0) ret1 prevs v (upt zero_nata i)
and next_subseqs2 f head tail ret0 ret1 prevs v [] =
  next_subseqs1 f head tail ret0 ret1 prevs
  | next_subseqs2 f head tail ret0 ret1 prevs v (j :: js) =
    let
...
fun check_divisors (A1_, A2_, A3_) l u a =
  less ((ord_preorder o preorder_order o order_linorder o
          linorder_linordered_nonzero_semiring o
          linordered_nonzero_semiring_linordered_semidom o
          linordered_semidom_discrete_linordered_semidom o
          discrete_linordered_semidom_check_prime_by_range)
         A2_)
    u l orelse
    not (dvd (A1_, A3_) l a) andalso
      check_divisors (A1_, A2_, A3_)
        (plus ((plus_semigroup_add o semigroup_add_numeral o
                 numeral_semiring_numeral o semiring_numeral_semiring_1 o
                 semiring_1_semiring_char_0 o
                 semiring_char_0_linordered_nonzero_semiring o
                 linordered_nonzero_semiring_linordered_semidom o
                 linordered_semidom_discrete_linordered_semidom o
                 discrete_linordered_semidom_check_prime_by_range)
                A2_)
          l (one ((one_numeral o numeral_semiring_numeral o
                    semiring_numeral_semiring_1 o semiring_1_semiring_char_0 o
                    semiring_char_0_linordered_nonzero_semiring o
                    linordered_nonzero_semiring_linordered_semidom o
                    linordered_semidom_discrete_linordered_semidom o
                    discrete_linordered_semidom_check_prime_by_range)
...
fun next_primes n =
  (if equal_nata n zero_nata then next_candidates zero_nata
         ...
         in
           (m, filter
                 (prime
                   (equal_nat, check_prime_by_range_nat, semidom_modulo_nat))
                 ps)
         end);
  ...
  in
    plus_inta (mahler_approximation (nat_of_integer (2 : IntInf.int)) binom f)
      (times_inta (int_of_nat binom)
        (abs_inta (coeff zero_int f (degree zero_int f))))
  end;
...
fun square_free_factorization_inta f =
  (if equal_nata (degree zero_int f) zero_nata
    then (coeff zero_int f (degree zero_int f), [])
           ...
           val c = content semiring_gcd_int f;
           val d =
             times_inta (sgn_inta (coeff zero_int f (degree zero_int f))) c;
...
fun n_of e =
  binary_power monoid_mult_nat (nat_of_integer (2 : IntInf.int))
    (binary_power monoid_mult_nat (nat_of_integer (2 : IntInf.int)) e);

fun scale_for_fractional_shift den acc [] = []
  | scale_for_fractional_shift den acc (x :: xs) =
    times_inta x acc :: scale_for_fractional_shift den (times_inta acc den) xs;

fun ruffini_step A_ c a [] = [a]
  | ruffini_step A_ c a (q :: qs) =
    plus ((plus_semigroup_add o semigroup_add_numeral o numeral_neg_numeral o
            neg_numeral_ring_1 o ring_1_comm_ring_1)
           A_)
      a (times
          ((times_dvd o dvd_comm_monoid_mult o
             comm_monoid_mult_comm_semiring_1 o
            ...
            A_)
          c q) ::
      ruffini_step A_ c q qs;

fun taylor_shift_list A_ c [] = []
  | taylor_shift_list A_ c (a :: asa) =
    ruffini_step A_ c a (taylor_shift_list A_ c asa);

fun fractional_taylor_shift c xs =
  let
    val (n, d) = quotient_of c;
    val a = rev (scale_for_fractional_shift d one_inta (rev xs));
  in
    taylor_shift_list comm_ring_1_int n a
  end;

fun sign_step (A1_, A2_) x (last_s, n) =
  (if eq A1_ x
        (zero ((zero_abs_if o abs_if_linordered_ring o
                ...
                A2_))
    then (last_s, n)
    else (if eq A1_ last_s
               (zero ((zero_abs_if o abs_if_linordered_ring o
                        linordered_ring_linordered_ring_strict o
                        linordered_ring_strict_linordered_idom)
                       A2_))
           then (sgn ((sgn_idom_abs_sgn o idom_abs_sgn_linordered_idom) A2_) x,
                  zero_nata)
           else (if not (eq A1_
                          (sgn ((sgn_idom_abs_sgn o
                                  idom_abs_sgn_linordered_idom)
                                 A2_)
                            x)
                          last_s)
                  then (sgn ((sgn_idom_abs_sgn o idom_abs_sgn_linordered_idom)
                              A2_)
                          x,
                         plus_nata n one_nata)
                  else (last_s, n))));

fun sign_changes_fold (A1_, A2_) xs =
  snd (fold (sign_step (A1_, A2_)) xs
        (zero ((zero_abs_if o abs_if_linordered_ring o
                 linordered_ring_linordered_ring_strict o
                 linordered_ring_strict_linordered_idom)
                A2_),
...
fun scale_poly_list_aux A_ c acc [] = []
  | scale_poly_list_aux A_ c acc (x :: xs) =
    times ((times_dvd o dvd_comm_monoid_mult o
             comm_monoid_mult_comm_semiring_1 o
             comm_semiring_1_comm_semiring_1_cancel o
             comm_semiring_1_cancel_comm_ring_1)
...
fun fast_descartes_list_int a b xs =
  let
    val (_, da) = quotient_of a;
    val p1 = fractional_taylor_shift a xs;
    val (nw, dw) = quotient_of (times_rata (minus_rata b a) (of_int da));
    val p3 =
      scale_for_fractional_shift dw one_inta
        (rev (scale_poly_list comm_ring_1_int nw p1));
    val aa = taylor_shift_list comm_ring_1_int one_inta p3;
  in
    sign_changes_fold (equal_int, linordered_idom_int) aa
  end;

fun dsc_main_int p todo acc =
  (case todo of [] => acc
    | (a, b) :: todoa =>
      let
        val v = fast_descartes_list_int a b (coeffs zero_int p);
      in
        (if equal_nata v zero_nata then dsc_main_int p todoa acc
          else (if equal_nata v one_nata
                 then dsc_main_int p todoa ((a, b) :: acc)
                 else let
                        val m =
                          divide_rata (plus_rata a b)
                            (of_int (Int_of_integer (2 : IntInf.int)));
                        val c =
                          (if equal_rata
                                (fold_coeffs zero_int
                                  (fn aa => fn ba =>
                                    plus_rata (of_int aa) (times_rata m ba))
                                  p zero_rata)
                                zero_rata
                            then (m, m) :: acc else acc);
                      in
                        dsc_main_int p ((a, m) :: (m, b) :: todoa) c
                      end))
      end);

fun dsc_int a b p = dsc_main_int p [(a, b)] [];
...
fun snap_window_rat a b n lam =
  let
    val w = minus_rata b a;
    val s = times_nata (nat_of_integer (4 : IntInf.int)) n;
    val step = divide_rata w (of_nat semiring_1_rat s);
    val k0 =
      floor_real
        (times_reala (of_nat semiring_1_real s)
          (divide_reala (minus_reala lam (ratreal a)) (ratreal w)));
    val k =
...
fun try_newton_int a b n p v =
  let
    val p_real =
      map_poly zero_int (zero_real, equal_real) (of_inta ring_1_real) p;
    val l1 = newton_at (int_of_nat v) p_real (ratreal a);
    val l2 = newton_at (int_of_nat v) p_real (ratreal b);
  in
    (case l1
      of NONE =>
        (case l2 of NONE => NONE
          | SOME lam2 =>
            let
              val i2 = snap_window_rat a b n lam2;
              val v2 =
                fast_descartes_list_int (fst i2) (snd i2) (coeffs zero_int p);
            in
              (if equal_nata v2 v then SOME i2 else NONE)
            end)
      | SOME lam1 =>
        let
          val i1 = snap_window_rat a b n lam1;
          val v1 =
            fast_descartes_list_int (fst i1) (snd i1) (coeffs zero_int p);
        in
          (if equal_nata v1 v then SOME i1
            else (case l2 of NONE => NONE
                   | SOME lam2 =>
                     let
                       val i2 = snap_window_rat a b n lam2;
                       val v2 =
                         fast_descartes_list_int (fst i2) (snd i2)
                           (coeffs zero_int p);
                     in
                       (if equal_nata v2 v then SOME i2 else NONE)
                     end))
...
fun try_blocks_int a b n p v =
  let
    val w = minus_rata b a;
    val b1 = (a, plus_rata a (divide_rata w (of_nat semiring_1_rat n)));
    val b2 = (minus_rata b (divide_rata w (of_nat semiring_1_rat n)), b);
    val v1 = fast_descartes_list_int (fst b1) (snd b1) (coeffs zero_int p);
    val v2 = fast_descartes_list_int (fst b2) (snd b2) (coeffs zero_int p);
  in
    (if equal_nata v1 v then SOME b1
      else (if equal_nata v2 v then SOME b2 else NONE))
  end;

fun newdsc_main_int p todo acc =
  (case todo of [] => acc
    | (a, (b, e)) :: todoa =>
      let
        val v = fast_descartes_list_int a b (coeffs zero_int p);
      in
        (if equal_nata v zero_nata then newdsc_main_int p todoa acc
          else (if equal_nata v one_nata
                 then newdsc_main_int p todoa ((a, b) :: acc)
                 else (case try_blocks_int a b (n_of e) p v
                        of NONE =>
                          (case try_newton_int a b (n_of e) p v
                            of NONE =>
                              let
                                val m =
                                  divide_rata (plus_rata a b)
                                    (of_int (Int_of_integer (2 : IntInf.int)));
                                val ea =
                                  max ord_nat one_nata (minus_nata e one_nata);
                                val c =
                                  (if equal_rata
(fold_coeffs zero_int
  (fn aa => fn ba => plus_rata (of_int aa) (times_rata m ba)) p zero_rata)
zero_rata
                                    then (m, m) :: acc else acc);
                              in
                                newdsc_main_int p
                                  ((a, (m, ea)) :: (m, (b, ea)) :: todoa) c
                              end
                            | SOME i =>
                              newdsc_main_int p
                                ((fst i, (snd i, plus_nata e one_nata)) ::
                                  todoa)
                                acc)
                        | SOME i =>
                          newdsc_main_int p
                            ((fst i, (snd i, plus_nata e one_nata)) :: todoa)
                            acc)))
      end);

fun newdsc_int a b e p = newdsc_main_int p [(a, (b, e))] [];
